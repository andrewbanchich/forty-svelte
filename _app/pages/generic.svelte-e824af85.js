import{S as w,i as z,s as B,e as s,t as P,k as b,c as r,a as u,g as _,d as n,n as E,b as l,P as F,f as J,D as t,E as M}from"../chunks/vendor-1bf0a882.js";function K(T){let i,m,e,o,p,x,D,c,d,k,I,v,N,C,h,G,S,f,j;return{c(){i=s("div"),m=s("section"),e=s("div"),o=s("header"),p=s("h1"),x=P("Generic"),D=b(),c=s("span"),d=s("img"),I=b(),v=s("p"),N=P(`Donec eget ex magna. Interdum et malesuada fames ac ante ipsum primis in faucibus.\r
				...
				amet. Pellentesque leo mauris, consectetur id ipsum sit amet, fersapien risus, commodo eget\r
				turpis at, elementum convallis elit. Pellentesque enim turpis, hendrerit tristique lorem\r
				ipsum dolor.`),R.forEach(n),a.forEach(n),y.forEach(n),g.forEach(n),this.h()},h(){l(o,"class","major"),F(d.src,k="images/pic11.jpg")||l(d,"src",k),l(d,"alt",""),l(c,"class","image main"),l(e,"class","inner"),l(m,"id","one"),l(i,"id","main"),l(i,"class","alt")},m(q,g){J(q,i,g),t(i,m),t(m,e),t(e,o),t(o,p),t(p,x),t(e,D),t(e,c),t(c,d),t(e,I),t(e,v),t(v,N),t(e,C),t(e,h),t(h,G),t(e,S),t(e,f),t(f,j)},p:M,i:M,o:M,d(q){q&&n(i)}}}class U extends w{constructor(i){super();z(this,i,null,K,B,{})}}export{U as default};
